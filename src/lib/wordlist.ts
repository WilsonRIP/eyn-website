// src/lib/wordlist.ts
// A sample from the EFF's wordlist. In a real app, this file would contain thousands of words.
...
export const effWordlist = [
  ...
  "absorb", "abstain", "abstract", "absurd", "accent", "acclaim", "acclimate",
  "accommodate", "accompany", "account", "accuracy", "accurate", "accustom",
  "achieve", "acoustic", "acquire", "acrobat", "action", "activate", "active",
  "activist", "activity", "actor", "actual", "adapt", "addict", "addition",
  "address", "adequate", "adjust", "administer", "admire", "admit", "adobe",
  "adopt", "adult", "advance", "advantage", "adventure", "advertise", "advice",
  "advocate", "aerial", "affair", "affect", "afford", "afraid", "aftermath",
  "afternoon", "again", "against", "age", "agency", "agenda", "agent",
  "agree", "ahead", "aim", "air", "airport", "aisle", "alarm", "album",
  "alcohol", "alert", "alien", "align", "alike", "alive", "allergy", "alley",
  ...
  "click", "client", "cliff", "climb", "cling", "clinic", "clip", "cloak",
  "clock", "clog", "close", "cloth", "cloud", "clown", "club", "clump",
  "cluster", "clutch", "coach", "coast", "coconut", "code", "coffee", "coil",
  "coin", "collect", "color", "column", "come", "comfort", "comic", "common",
  ...
  "cushion", "custom", "cute", "cycle", "dad", "damage", "dance", "danger",
  ...
  "gleam", "glide", "glimpse", "globe", "gloom", "glory", "glove", "glow",
  "glue", "goat", "goddess", "gold", "good", "goose", "gorilla", "grace",
  ...
  "pole", "police", "pond", "pony", "pool", "poor", "popular", "portion",
  ...
  "step", "stereo", "stick", "still", "sting", "stomach", "stone", "stool",
  ...
  "update", "upgrade", "uphold", "upon", "upper", "upright", "uprising", "uproar",
